...
- **GitHub**：Dify → 插件 → 通过 GitHub 安装 → `origin-power-ai/dify-plugin-origin-power-ai`；或在 [Releases](https://github.com/origin-power-ai/dify-plugin-origin-power-ai/releases) 下载 `.difypkg` 后从「本地文件」安装。
